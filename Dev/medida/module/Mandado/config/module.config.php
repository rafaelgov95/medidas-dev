 ...
 *
 * @link      http://github.com/zendframework/ZendSkeletonMandado for the canonical source repository
...
return array(
    'router' => array(
        'routes' => array(
            ...
            // using the path /mandado/:controller/:action
            'mandado' => array(
                'type'    => 'Literal',
                'options' => array(
                    'route'    => '/mandado',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Mandado\Controller',
                        'controller' => 'mandado',
                        'action' => 'index',
                        'order' => 'oficio',
                        'page' =>'1'
...
//                                'q' => '[a-zA-Z][a-zA-Z0-9_-]*'
    ...
    'controllers' => array(
        'invokables' => array(
            'Mandado\Controller\Index' => 'Mandado\Controller\IndexController',
            'Mandado\Controller\Mandado' => 'Mandado\Controller\MandadoController',
        ),
    ),
    'view_manager' => array(
        ...
        'template_map' => array(
            ...
            'mandado/index/index' => __DIR__ . '/../view/mandado/index/index.phtml',
