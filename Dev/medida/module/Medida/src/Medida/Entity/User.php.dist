 ...
 * User
 *
 * @ORM\Table(name="user", uniqueConstraints={@ORM\UniqueConstraint(name="Login_UNIQUE", columns={"login"}), @ORM\UniqueConstraint(name="Email_UNIQUE", columns={"email"})}, indexes={@ORM\Index(name="fk_user_acl_roles1_idx", columns={"role_id"})})
 * @ORM\Entity
 */
class User
{
